...
const TopPage = () => {
  const [importSourceUrlElementRef, setimportSourceUrlElementRef, setImportSourceUrl] = useLocalStorageInputElementRef("importSourceUrl", "https://raw.githubusercontent.com/vercel/next.js/canary/examples/with-typescript/pages/users/%5Bid%5D.tsx");
  ...
  const setimportSourceUrlElement = useCallback(async (node: HTMLInputElement) => {
    if (!node) return;
    ...
    <main className={styles.main}>
      ...
      <div className={styles.github_url_wrapper}>
        <TextField
          ...
          inputRef={setimportSourceUrlElement}
        />
